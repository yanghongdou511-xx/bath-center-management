...
const DB = {
  ...
  // 技师服务目录：按「擅长项目名」给出详细描述/价格/时长，详情弹窗与卡片展示复用
  TECH_SERVICE_CATALOG: {
    ...
    '经络疏通':       { desc: '沿十二正经走向梳理气血，疏通淤堵节点，缓解全身酸胀乏力。', price: 198, duration: 60 },
    '艾灸养生':       { desc: '选用三年陈艾温灸关元/足三里等保健要穴，祛寒除湿、温补阳气。', price: 188, duration: 45 },
    '刮痧拔罐':       { desc: '中医传统刮痧配合走罐，解表排毒，对感冒初起与肌肉劳损效果明显。', price: 158, duration: 40 },
    '中式推拿':       { desc: '中医正统一指禅推法，针对颈肩腰背劳损深层松解，力透筋骨。', price: 288, duration: 70, hot: true },
    ...
    '正骨复位':       { desc: '中医正骨手法调整小关节错位，针对颈腰椎生理曲度改善（需评估）。', price: 428, duration: 50, hot: true },
    ...
    '泡脚药膳':       { desc: '药食同源草本足浴方，温补气血、安神助眠。', price: 128, duration: 40 },
    '武术点穴':       { desc: '少林功夫点穴技法，刚柔并济，力道强劲，适合偏好大力按压者。', price: 338, duration: 70, hot: true },
    '拔罐刮痧':       { desc: '走罐配合刮痧，解表排毒，缓解肌肉劳损与肩背僵紧。', price: 158, duration: 40 },
    '背部整脊':       { desc: '沿脊柱两侧整复调理，改善含胸驼背与背部僵紧。', price: 298, duration: 50 },
    '脏腑推拿':       { desc: '柔和的腹部脏腑推拿，调理脾胃运化与肠腑功能。', price: 308, duration: 60 },
    '小儿推拿':       { desc: '针对儿童的轻柔穴位推拿，调理积食、感冒、睡眠（需家长陪同）。', price: 188, duration: 40 },
    '产后修复':       { desc: '骨盆闭合+腹直肌修复+盆底肌调理，助力产后形体恢复。', price: 468, duration: 80, hot: true },
    '腹部调理':       { desc: '温宫暖腹手法+精油，缓解痛经与腹部寒凉。', price: 218, duration: 45 },
    ...
    '面部抗衰':       { desc: '进口射频仪器+提拉手法，改善松弛与细纹，紧致轮廓。', price: 468, duration: 70, hot: true },
    '身体塑形':       { desc: '手法+仪器局部塑形，针对腰腹/手臂线条雕刻。', price: 428, duration: 70 },
    '乳腺疏通':       { desc: '轻柔疏通乳腺结节与淤堵，缓解经期前胀痛（专业手法）。', price: 268, duration: 50 },
    '卵巢保养':       { desc: '腹部温疗+穴位调理，养护卵巢功能、改善畏寒。', price: 288, duration: 55 },
    '日式指压':       { desc: '日式Shiatsu指尖按压，节奏舒缓，调理全身气血平衡。', price: 328, duration: 75 },
    '禅意头疗':       { desc: '穴位刺激结合冥想引导，深度放松神经、改善失眠焦虑。', price: 228, duration: 50 },
    '肩颈深度放松':   { desc: '针对上交叉综合征的精准松解，立竿见影缓解僵硬。', price: 198, duration: 45, hot: true },
    '睡眠调理':       { desc: '安神穴位推拿+轻音乐引导，帮助入睡困难者放松。', price: 238, duration: 55 },
    '全身经络疏通':   { desc: '通体经络梳理+精油开背，一站式放松全身。', price: 368, duration: 90 }
  },
  ...
  technicians: [
    ...
    },
    {
      ...
      tags: ['新锐技师', '运动恢复'],
      schedule: '中班 12:00-20:00', phone: '137****7788', cert: '针灸推拿学士 · 五星酒店SPA经历', store: '中心店', today: 3
    },
    {
    ...
    },
    {
      ...
      tags: ['中医世家', '正骨专家', '元老技师'],
      schedule: '早班 09:00-17:00', phone: '151****2233', cert: '中医正骨传承人 · 从业12年', store: '中心店', today: 7
    },
    {
    ...
    },
    {
      ...
      tags: ['功夫按摩', '大力士'],
      schedule: '晚班 16:00-24:00', phone: '153****1100', cert: '少林俗家弟子 · 功夫按摩', store: '中心店', today: 5
    },
    {
      id: 'T1008', name: '刘诗涵', gender: '女', empNo: 'E4008',
      avatar: '👩‍🦰', category: '中医推拿师', specialties: ['脏腑推拿', '小儿推拿', '产后修复', '腹部调理'],
      ...
      tags: ['医学硕士', '产后修复', '小儿推拿'],
      schedule: '早班 09:00-17:00', phone: '154****4455', cert: '北京中医药大学硕士', store: '旗舰店', today: 8
    },
    {
